                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6 col-sm-6 col-md-6 col-lg-6 text-end fs-3 text-uppercase">
                                    <a href="" class="btn btn-primary rounded-pill fw-bold">Download CV</a>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 bg-white my-3 py-5 px-5 shadow">
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                            <div class="text-primary fw-bold fs-4">2022 - Present</div>
                                            <div class="fs-5">UNIVERSITY NAME</div>
                                            <div class="fs-5">Degree Level</div>
                                            <div class="fs-6 mt-2">University Location</div>
                                        </div>
                                        <div class="col-0 col-sm-0 col-md-1 col-lg-1"></div>
                                        <div class="col-12 col-sm-12 col-md-7 col-lg-7 pt-4">
                                            <i class="bi bi-square-fill text-primary me-1"></i>
                                            <span class="fs-5">I attended an Android Application Development competition
                                ...
                                <div class="col-12 bg-white my-3 py-5 px-5 shadow">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 mt-3">
                                            <div class="text-capitalize fs-5">SQL</div>
                                            <div class="progress">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 mt-3">
                                            <div class=""><i class="bi bi-square-fill text-primary"></i>
                                                <span class="fs-5">English (native)</span>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 mt-3">
                                            <div class=""><i class="bi bi-square-fill text-primary"></i>
