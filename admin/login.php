...
<body class="background-color-bone">
    <section class="">
                            ...
                            <form class="row g-3 needs-validation" novalidate>
                                <div class="col-md-12">
                                    <label for="validationFirstName" class="form-label fw-bold">First
                                        name</label>
                                    <input type="text" class="form-control" id="validationFirstName" value="" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="validationLastName" value="" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" name="email" id="validationEmail" value=""
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" name="phone" id="validationPhone" value=""
                                        required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
