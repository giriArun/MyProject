                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <table id="projectsTable" class="table cell-border hover order-column stripe w-100" >
                                                        <thead class="table-secondary">
                                                            <tr>
                                                                <th>Project Name</th>
                                                                <th class="d-md-none">Project Role</th>
                                                                <th>Start Date</th>
                                                                <th>End Date</th>
                                                                <th class="text-end">
                                                                    <a href="addEditProject.php" class="btn btn-primary" title="Add">
                                                                    ...
                                                                    foreach ( $projectsData[ "data" ] as $projectData) {
                                                                        ?>
                                                                            <tr>
                                                                                ...
                                                                                <td class="d-md-none"><?=$projectData[ "projectRoleType" ];?></td>
                                                                                <td><?=$projectData[ "stratDate" ];?></td>
                                                                                <td><?=$projectData[ "isContinue" ] == 1 ? "Continue" : $projectData[ "endDate" ];?></td>
                                                                                <td class="text-end">
                                                                                    <a href="addEditProject.php?id=<?=$projectData[ "projectId" ];?>" class="btn btn-warning" title="Edit">
