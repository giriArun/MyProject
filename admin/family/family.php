                                    ...
                                    <thead class="table-secondary">
                                        <tr>
                                            ...
                                            <th scope="col" class="text-end">
                                                <a href="<?=$_config[ "root_path_admin" ];?>/?action=addEditFamily" class="btn btn-primary" title="Add">
                                                ...
                                                foreach ( $familyData[ "data" ] as $family ){
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                <a href="<?=$_config[ "root_path_admin" ];?>/?action=addEditFamily&id=<?=$family[ "familyId" ];?>" class="btn btn-warning" title="Edit">
