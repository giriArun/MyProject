...
INSERT INTO `projects` (`project_id`, `user_id_fk`, `project_name`, `project_site_url`, `project_role_id_fk`, `start_date`, `end_date`, `isContinue`, `project_technologies`, `project_tools`, `project_description`, `project_image`, `created_on`, `created_by`, `modified_on`, `modified_by`) VALUES
